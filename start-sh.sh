...
# run orderer
docker stack deploy -c docker-compose-orderer-SH.yaml cloudex

# run ca peers and cli
org1ca=$org1ca org2ca=$org2ca org3ca=$org3ca docker stack deploy -c docker-compose-SH.yaml cloudex
